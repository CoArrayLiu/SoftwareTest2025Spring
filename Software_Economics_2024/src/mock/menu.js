    ...
    children: [
      {
        ...
        target: '_self',
        path: '/exp2/ifpug',
        component: '@/pages/exp2/IFPUG/index.vue',
        renderMenu: true,
        permission: null,
        cacheable: true,
      },
      {
        ...
        target: '_self',
        path: '/exp2/nesma',
        component: '@/pages/exp2/NESMA/index.vue',
        renderMenu: true,
        permission: null,
        cacheable: true,
      },
      {
        ...
        // target: '_self',
        // path: '/exp2/markii',
        // component: '@/pages/exp2/MARKII/index.vue',
        // renderMenu: true,
        // permission: null,
        // cacheable: true,
      },
      {
        ...
        target: '_self',
        path: '/exp2/cosmic',
        component: '@/pages/exp2/COSMIC/index.vue',
        renderMenu: true,
        permission: null,
        cacheable: true,
      },
      {
        ...
        title: '碳排放交易配额优化算法',
        target: '_self',
        path: '/exp2/tanpaifang15',
        component: '@/pages/exp2/TANPAIFANG15/index.vue',
        renderMenu: true,
        permission: null,
        cacheable: true,
      },
    ...
    children: [
      {
        ...
        title: '开发成本估算实验1',
        target: '_self',
        path: '/exp2_previous/chengbengusuan',
        component: '@/pages/exp1/Exp2_Chengbengusuan',
        renderMenu: true,
        permission: null,
        cacheable: true,
      }
    ...
    children: [
      {
        ...
        title: '碳排放权供需方法',
        target: '_self',
        path: '/exp1/tanpaifang',
        component: '@/pages/exp1/Exp6_TANPAIFANG/index.vue',
        renderMenu: true,
        permission: null,
        cacheable: true,
      }
